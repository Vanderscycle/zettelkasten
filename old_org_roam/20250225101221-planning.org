...
****** TODO use `never let go` dan john (single body part)
****** TODO create peridization + planning (month cycle/tracking) in emacs
...
***** DONE create proxmox cluster
      CLOSED: [2025-09-30 Tue 20:43]
      - State "DONE"       from "TODO"       [2025-09-30 Tue 20:43]
***** DONE nuke the kubernetes machine
      CLOSED: [2025-09-30 Tue 20:43]
      - State "DONE"       from "TODO"       [2025-09-30 Tue 20:43]
***** TODO Configure paperless smb access
***** DONE Troubleshoot nextcloud smb write timeout
      CLOSED: [2025-09-30 Tue 20:44]
      - State "DONE"       from "TODO"       [2025-09-30 Tue 20:44]
***** DONE Configure DNS + TLS (https)
      ...
      -
**** Emacs [0/4]
     ~SPC h SPC~ for all the help documentaion
     check phone
     tldr: clean up org-roam/integrate org-mode in my life more/
     get protonmail
...
***** TODO use nix-writers for small scripts
***** TODO host a website w/ my notes using org mode
